...
MemTotal = int(input("enter the memtotal")) #7858500 
MemFree = int(input("enter the memFree")) #647000 
MemAvailable = int(input("enter the memAvailable")) #2487576 
Buffer = int(input("enter the Buffer")) #244416 

print (kb_in_mb(MemTotal),kb_in_mb(MemFree),kb_in_mb(MemAvailable),kb_in_mb(MemTotal),sep="")
...
lines = """MemTotal:        7858500 kB
 ...
 Buffers:          244416 kB
 """
lst = [ int(s)  for s in lines.split() if s.isdigit()]
#print(lst)
lst1 = []
for i in range(len(lst)):
    lst1.append(int(lst[i]/1024))
    #print(lst1)
print("MemTotal", lst[0], "MemFree", lst[1], "MemAvailable", lst[2], "Buffer", lst[3], sep=" Mb\n") #how to separate the numbers from string;see the output 
#leaving it as it is to get suggestions on this 
...
#data = urllib.request.urlopen('https://dgplug.org/irclogs/2017/Logs-2017-06-18-13-41.txt').read().decode("utf-8")
# print(data)
data = """----BEGIN CLASS----
...
nicks_set= set(nicks)
print(nicks_set) #to print all the present nicks
print("Total nicks present: ")
print(len(nicks_set)) #total nicks present
#print(nicks)
nick_count = {}
for nick in nicks:
...
for keys,values in nick_count.items():
    print(keys,":",values ,"lines") #Each nick's participation by no. of lines
    #words part still remaining ; remove eof,eom,EOF,most importantly get it reviewed 
